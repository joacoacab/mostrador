...
class BotTokenAuthenticationScheme(OpenApiAuthenticationExtension):
    target_class = "tenants.authentication.BotTokenAuthentication"
    name = "botTokenAuth"
    ...
    def get_security_definition(self, auto_schema):
        return {
            ...
            "in": "header",
            "name": "Authorization",
            "description": "Formato: `BotToken <token>` (ver tarea 25, whatsapp-agent).",
        }
